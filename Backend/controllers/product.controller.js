...
export const createProduct = async(req,res)=>{
    try {
        ...
        console.log("Error in createProduct handler",error.message);
        res.status(500).json({error:error.message})
    }
}
    ...
    try {
        ...
        if(product.image){
            ...
            try {
                ...
                console.log("Error in cloudinary delete handler",error);
            }
        }
...
async function updateFeaturedProductsCache(){
    try {
        // lean is used to return plain js objects instead of mongoose documents
